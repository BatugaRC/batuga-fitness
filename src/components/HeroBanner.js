...
const HeroBanner = () => {
  return (
    <Box sx={{
        ...
        <Typography fontSize="22px" mb={6} lineHeight="35px"  >
            Check out the most effective exercises
        </Typography>
        <Typography fontWeight={600} color="#ff2625" sx={{opacity:"0.1", display: {lg: "block", xs: "none"}}} fontSize="200px">Exercise</Typography>
        <Button sx={{backgroundColor: "#ff2625", padding:"10px"}} variant="contained" href="#exercises" color="error">Explore Exercises</Button>
